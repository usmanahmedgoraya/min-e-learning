...
Add the NEXT_PUBLIC_API_URL of backend URL 
 

 - For backend Repo, here is the [backend link](https://github.com/usmanahmedgoraya/mini-e-learning-backend)
...
- Further Add new Small Changes in UI